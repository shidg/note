...
function MODIFY_PROFILES() {
    ...
    sed -i "/^uat.meta/ s/=.*/=http:\/\/meta.apollo.uat.eg.com:8582/" consumer-app/src/main/resources/apollo-env.properties
    ...
    sed -i "/^qrcode_url/ s/=.*/=https:\/\/appprep.eg.com/" consumer-app/src/main/resources/config.properties
    ...
    sed -i "/^img.ftp.host/ s/=.*/=imgprep.eg.com/" consumer-app/src/main/resources/ftpconfig.properties
    ...
    sed -i "/^img.http.host/ s/=.*/=imgprep.eg.com/" consumer-app/src/main/resources/ftpconfig.properties
	...
	### manage-orders ###
    # acp_sdk.properties
    sed -i "/^create_backURL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/unionpay\/callback/" manage-orders/src/main/resources/acp_sdk.properties
    ...
    sed -i "/^create_renew_backURL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/unionpay\/callbackRenew/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^refund_backURL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/unionpay\/refundCallback/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^EPPS_NOTIFY_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/epps\/notify/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^EPPS_RETURN_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/epps\/epps_return/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^EPPS_REFUND_NOTIFY_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/epps\/refundNotify/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^ALI_NOTIFY_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/ali\/notifyByAlipay/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^ALI_RECHARGE_NOTIFY_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/ali\/rechargeCallback/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^ALI_RETURN_URL/ s/=.*/=https:\/\/mprep.eg.com\/paycallback/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^WECHAT_NOTIFY_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/wechat\/payCallback/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^WECHAT_RECHARGE_NOTIFY_URL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/wechat\/rechargeCallback/" manage-orders/src/main/resources/acp_sdk.properties
    sed -i "/^WECHAT_RETURN_URL/ s/=.*/=https:\/\/mprep.eg.com\/paycallback/" manage-orders/src/main/resources/acp_sdk.properties

    # apollo-env.properties
    sed -i "/^server.env/ s/=.*/=uat/" manage-orders/src/main/resources/apollo-env.properties
    sed -i "/^uat.meta/ s/=.*/=http:\/\/meta.apollo.uat.eg.com:8582/" manage-orders/src/main/resources/apollo-env.properties
    ...
    # ftpconfig.properties
    sed -i "/^img.ftp.host/ s/=.*/=imgprep.eg.com/" manage-orders/src/main/resources/ftpconfig.properties
    sed -i "/^img.http.host/ s/=.*/=imgprep.eg.com/" manage-orders/src/main/resources/ftpconfig.properties
    ...
    # refund.properties
    sed -i "/^user.applay.refund.peccancy/ s/=.*/=https:\/\/appprep.eg.com\/payment\/ali\/refundCallback/" manage-orders/src/main/resources/refund.properties
    ...
    sed -i "/^uat.meta/ s/=.*/=http:\/\/meta.apollo.uat.eg.com:8582/" manage-web/src/main/resources/apollo-env.properties
    ...
    sed -i "/^qrcode_url/ s/=.*/=https:\/\/appprep.eg.com/" manage-web/src/main/resources/config.properties
    ...
    # ftpconfig.properties
    sed -i "/^img.ftp.host/ s/=.*/=imgprep.eg.com/" manage-web/src/main/resources/ftpconfig.properties
    sed -i "/^img.http.host/ s/=.*/=imgprep.eg.com/" manage-web/src/main/resources/ftpconfig.properties
    ...
    sed -i "/^uat.meta/ s/=.*/=http:\/\/meta.apollo.uat.eg.com:8582/" manage-metadata/src/main/resources/apollo-env.properties
    ...
    # ftpconfig.properties
    sed -i "/^img.ftp.host/ s/=.*/=imgprep.eg.com/" manage-metadata/src/main/resources/ftpconfig.properties
    ...
    sed -i "/^img.http.host/ s/=.*/=imgprep.eg.com/" manage-metadata/src/main/resources/ftpconfig.properties
    ...
    # hbase-site.xml
    #sed -i "s/hdfs:\/\/hbase.eg.com/hdfs:\/\/10.162.198.246/" manage-datawarehouse/src/main/resources/hbase-site.xml
    #sed -i "s/>1</>3</" manage-datawarehouse/src/main/resources/hbase-site.xml
    #sed -i "s/>hbase.eg.com:60000</>10.162.198.246:16000</" manage-datawarehouse/src/main/resources/hbase-site.xml
    #sed -i "s/>hbase.eg.com</>10.162.198.246</" manage-datawarehouse/src/main/resources/hbase-site.xml
    ...
    sed -i "/^Request.ConsumerApp.Url/ s/=.*/=https:\/\/appprep.eg.com/" wechat/src/main/resources/config.properties
    sed -i "/^YwxWeiXin.Url/ s/=.*/=https:\/\/prepwx.eg.com/" wechat/src/main/resources/config.properties
    ...
    # base.js
    sed -i "/apiUrl/ s/\/\/.*/\/\/appprep.eg.com',/" wechat/WebContent/resources/js/base.js
	...
	### manage-report ###
    # acp_sdk.properties
    sed -i "/^create_backURL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/unionpay\/callback/" manage-report/src/main/resources/acp_sdk.properties
    ...
    sed -i "/^create_renew_backURL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/unionpay\/callbackRenew/" manage-report/src/main/resources/acp_sdk.properties
    sed -i "/^refund_backURL/ s/=.*/=https:\/\/appprep.eg.com\/payment\/unionpay\/refundCallback/" manage-report/src/main/resources/acp_sdk.properties

    # apollo-env.properties
    sed -i "/^server.env/ s/=.*/=uat/" manage-report/src/main/resources/apollo-env.properties
    sed -i "/^uat.meta/ s/=.*/=http:\/\/meta.apollo.uat.eg.com:8582/" manage-report/src/main/resources/apollo-env.properties
    ...
    # ftpconfig.properties
    sed -i "/^img.ftp.host/ s/=.*/=imgprep.eg.com/" manage-report/src/main/resources/ftpconfig.properties
    ...
    sed -i "/^img.http.host/ s/=.*/=imgprep.eg.com/" manage-report/src/main/resources/ftpconfig.properties
    ...
    # ftpconfig.properties
    sed -i "/^img.ftp.host/ s/=.*/=imgprep.eg.com/" manage-thirdparty/src/main/resources/ftpconfig.properties
    ...
    sed -i "/^img.http.host/ s/=.*/=imgprep.eg.com/" manage-thirdparty/src/main/resources/ftpconfig.properties
    # jdbc.properties
    ...
    sed -i "/^CONSUMER_APP_URL/ s/=.*/=https:\/\/appprep.eg.com/" consumer-wap/src/main/resources/config.properties
...
function GET_READY_FOR_DM() {
	...
	case $option in
    	prep)
			...
			sed -i "/^file.http.host/ s/=.*/=imgprep.eg.com/" gateway-deliver-config.properties
            ...
            cd ${DM_SOURCE_DIR}/device-manage-service/src/main/resources
            # hbase-site.xml
    		sed -i "s/hdfs:\/\/hbase.eg.com/hdfs:\/\/10.162.198.246/" hbase-site.xml
    		#sed -i "s/>1</>3</" hbase-site.xml 
    		sed -i "s/>hbase.eg.com:60000</>10.162.198.246:16000</" hbase-site.xml
    		sed -i "s/>hbase.eg.com</>10.162.198.246</" hbase-site.xml
    	...
    	product)
			...
			# hbase-site.xml
            cd ${DM_SOURCE_DIR}/device-manage-service/src/main/resources
    		sed -i "s/hdfs:\/\/hbase.eg.com/hdfs:\/\/K-master/" hbase-site.xml
    		sed -i "s/>1</>3</" hbase-site.xml
    		sed -i "s/>hbase.eg.com:60000</>K-master:16000</" hbase-site.xml
    		sed -i "s/>hbase.eg.com</>K-slave1,K-slave2,K-slave3</" hbase-site.xml
    		sed -i "s/>false</>true</" hbase-site.xml
			...
			sed -i "/^file.http.host/ s/=.*/=img.eg.com/" gateway-deliver-config.properties
