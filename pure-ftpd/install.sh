...
#安装pure-ftpd
cd ..
tar jxvf pure-ftpd-1.0.36.tar.bz2 && cd pure-ftpd-1.0.36 && ./configure --prefix=/Data/app/pure-ftpd --with-puredb --with-ftpwho --with-welcomemsg --with-virtualhosts --with-virtualchroot --with-diraliases --with-language=english --with-rfc2640 --with-tls  --with-certfile=/etc/ssl/private/pure-ftpd.pem
make && make install
